		...
		<div class="container">
			<div class="row">
				<div class="col-sm-6 col-sm-offset-3">
					<h2 class="module-title font-alt">My List of Inquiries</h2>
				...
				<div class="col-sm-12">
					<table class="table table-striped table-border checkout-table">
						<tbody>
							...
							<c:forEach items="${mylist }" var="ivo">
								<tr>
									<td class="hidden-xs">${ivo.rno }</td>
									<td><a class="move" href="${ivo.rno }">
											<h5 class="product-title font-alt">${ivo.title }</h5>
									</a></td>
									<td class="hidden-xs">
							...
							<c:if test="${empty mylist}">
								<tr>
									<td colspan="5" style="text-align: center;">문의글이 존재하지않습니다.</td>
								</tr>
							</c:if>
						</tbody>
					</table>
