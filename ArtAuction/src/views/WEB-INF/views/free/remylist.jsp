          ...
          <div class="container">
            ...
            <div class="row">
              <div class="col-sm-8 col-sm-offset-2">
                <h2 class="module-title font-alt mb-0">내가 작성한 댓글</h2>
              </div>
            </div>
          </div>
        </section>
		...
		<div class="row main">
                <div class="col-lg-12">
                          ...
                          <!--   <table width="100%" 
                            ...
                            <table class="table table-hover" style="table-layout:fixed">
                              ...
                              <c:forEach items="${mylist }" var="mylist">
                                ...
                                <tr>
                                	<td style =' vertical-align : middle '>${mylist.rpno }</td>
                                	<td style =' vertical-align : middle '>${mylist.frno }</td>
                                	<td style =' vertical-align : middle '><a class="move" data-mid="${mylist.mid }" href="${mylist.frno }" >${mylist.title }</a></td>
                                	<td style =' vertical-align : middle; text-overflow: ellipsis; '>${mylist.reply }</td>
				   ...
				   <!-- 현재 페이지 번호 및 출력 게시물 수 전송 폼 -->
					<form action="/free/remylist" id="actionFrm" >
