...
<section class="module bg-dark-30 parallax-bg restaurant-menu-bg" data-background="/resources/live/assets/images/restaurant/cake_pastries_bg.jpg" style="background-image: url(&quot;/resources/live/assets/images/restaurant/cake_pastries_bg.jpg&quot;);">
          <div class="container">
            <div class="row">
              <div class="col-sm-2 col-sm-offset-5">
                <div class="alt-module-subtitle"><span class="holder-w"></span>
                  <h5 class="font-serif">Artist</h5><span class="holder-w"></span>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-sm-8 col-sm-offset-2">
                <h2 class="module-title font-alt mb-0">작가 신청</h2>
              </div>
            </div>
          </div>
        </section>
	...
	<div class="main">
			 <div class="centered-content">
				...
				<form action="/user/request" method="post" class="form-horizontal requeform ">
					<div class="form-group">
						<label><b>분야정보</b></label>
						<div class="input">
							<select class="form-control" name="major1" id="major1" 
							onchange="javascript:setMajor(this)">
								<option selected value="회화">회화</option>
					...
					<div class="form-group">
						<label><b>소개</b></label>
						<div class="input">
           						 <textarea name="introduce" id="introduce" class="form-control" required >소개를 입력해주세요.</textarea>
					...
					<div class="find-btn"> 
							...
							<input type="submit" class="okBtn btn find-btn1" value="등록">			 
					</div>
	...
	function showFile(result){
		...
		var liTag = '';    // 변수 초기화  li태그 다 가져오기
       		 ...
       		 liOpenTag = '<li class="photo" data-fileName="' + result.photo + '">';
       		 ...
       		 console.log(result.photo)
     			...
     			liTag += liOpenTag + '<img src="/display?fileName=' + uri + '"><br>' + result.photo
     				  ...
     				  + 'type="button" class=" btn btn-warning btn-circle deBtn" data-file="' 
     				  + uri + '"' + 'data-type="image"><i class="fa fa-times"></i></button></li>';
